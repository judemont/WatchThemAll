...
langQuestion = [
    inquirer.List("langCode", message="Movie language", choices=[("English", "en-EN"), ("French", "fr-FR")])
]
...
while not (tmdbUrl.startswith("https://themoviedb.org/") or tmdbUrl.startswith("https://www.themoviedb.org/")):
...
with open("./movies.json", "w") as file:
    file.write(json.dumps(moviesData, indent=2))